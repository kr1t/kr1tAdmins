...
const showNote = () => noteShow.value = false
</script>
    ...
    <aside class="w-64" aria-label="Sidebar">
        <div class="py-4 px-3 bg-gray-50 rounded dark:bg-gray-800 h-full">
            <ul class="space-y-2">
                ...
                <li>
                    <RouterLink :to="{ name: 'admin-image' }"
                        class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Image Generater</span>
                    </RouterLink>
                </li>
                <li>
                    <RouterLink :to="{ name: 'admin-tags' }"
                        class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path
            ...
            <div v-if="noteShow" id="dropdown-cta" class="p-4 mt-6 bg-blue-50 rounded-lg dark:bg-blue-900" role="alert">
                <div class="flex items-center mb-3">
                    ...
                    <button type="button"
                        ...
                        data-collapse-toggle="dropdown-cta" aria-label="Close" @click="showNote()">
